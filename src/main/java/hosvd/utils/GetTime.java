...
class TensorStruct {
    ...
    public void setErrors(int i , double error) {
        errors[i-1] = error;
    }
...
public class GetTime {
    ...
    public static Tensor getTensor(String tensorSize, String tensorSplits) {
        final int Ranks = 3;
...
//                    in = new Scanner(new File(pathOfi + "error.txt"));
//                    double error = in.nextDouble();
//                    struct.setErrors(i,error);
//                    in.close();
...
//                System.out.println(Arrays.toString(tensorStruct.getErrors()) + ",");
